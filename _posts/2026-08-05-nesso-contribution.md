...
---
I'm glad to be contributing to the open-source codebase through PR #3. I identified two training-only tensors — `disto_target` and `token_to_rep_atom` — that were still being generated and transferred during inference even though Nesso-1's forward pass never used them.
